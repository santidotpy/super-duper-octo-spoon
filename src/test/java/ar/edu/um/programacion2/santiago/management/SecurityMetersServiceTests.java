package ar.edu.um.programacion2.santiago.management;
...
class SecurityMetersServiceTests {
    ...
    void testCountMethodsShouldBeBoundToCorrectCounters() {
        ...
        assertThat(meterRegistry.get(INVALID_TOKENS_METER_EXPECTED_NAME).tag("cause", "unsupported").counter().count())
                .isZero();
