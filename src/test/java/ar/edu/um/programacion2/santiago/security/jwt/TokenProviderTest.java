package ar.edu.um.programacion2.santiago.security.jwt;

import static org.assertj.core.api.Assertions.assertThat;

import ar.edu.um.programacion2.santiago.management.SecurityMetersService;
...
class TokenProviderTest {
    ...
    public void setup() {
        ...
        String base64Secret = "x3ze0tqdpwxdz16fmp3mi4dunl8e4ekjwjmzslit1otk1odfxwyw30whyd8e0j9grhe4u8sovrbs043j9lz3sqkx9k3jz";
    ...
    void testKeyIsSetFromBase64SecretWhenSecretIsEmpty() {
        final String base64Secret = "x3ze0tqdpwxdz16fmp3mi4dunl8e4ekjwjmzslit1otk1odfxwyw30whyd8e0j9grhe4u8sovrbs043j9lz3sqkx9k3jz";
        JHipsterProperties jHipsterProperties = new JHipsterProperties();
        jHipsterProperties.getSecurity().getAuthentication().getJwt().setBase64Secret(base64Secret);
    ...
    private String createTokenWithDifferentSignature() {
        Key otherKey = Keys.hmacShaKeyFor(
            Decoders.BASE64.decode("Xx3ze0tqdpwxdz16fmp3mi4dunl8e4ekjwjmzslit1otk1odfxwyw30whyd8e0j9grhe4u8sovrbs043j9lz3sqkx9k3jz")
        );
